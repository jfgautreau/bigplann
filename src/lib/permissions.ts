...
export const MODULES: { key: string; label: string; href: string; admin: boolean }[] = [
  ...
  { key: "referentiel", label: "Referentiel", href: "/admin/referentiel", admin: true },
  { key: "equipes", label: "Equipes", href: "/admin/equipes", admin: true },
  { key: "competences", label: "Competences", href: "/admin/competences", admin: true },
